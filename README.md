...
[**Capítulo V: Product Implementation, Validation & Deployment.**](#5) <br>
   ...
   &emsp;&emsp;5.2.2.8. [Team Collaboration Insights during Sprint](#5228) <br>
...
| US05          | Actualizar perfil de usuario                         | **Como** usuario registrado,<br>**Quiero** poder actualizar mis datos personales desde mi perfil,<br>**Para** mantener mi información actualizada. | **Escenario 1:**<br>**Dado que** los usuarios pueden cambiar de correo, nombre o imagen con el tiempo,<br><br>**Cuando** accedan a la sección de perfil y editen su información personal,<br><br> **Entonces** los cambios deben guardarse correctamente y reflejarse de inmediato en su cuenta, mostrando un mensaje de confirmación exitoso.| EPIC03                  |
...
| US44 | Desarrollo de Devices | Como developer de TukunTech,<br>Quiero implementar la sección de dispositivos,<br>Para visualizar todos los dispositivos registrados en la plataforma. | Escenario 1:<br>Dado que el developer de TukunTech está trabajando en la sección de dispositivos,<br><br>Cuando la sección de dispositivos se implemente correctamente,<br><br>Entonces se deben mostrar todos los dispositivos registrados con su información correspondiente. | EPIC03 |
| US45 | Desarrollo de Map Radiation | Como developer de TukunTech,<br>Quiero implementar la sección del mapa de radiación,<br>Para visualizar los niveles de radiación registrados por zona geográfica. | Escenario 1:<br>Dado que el developer de TukunTech está trabajando en el mapa de radiación,<br><br>Cuando el mapa se implemente correctamente,<br><br>Entonces se deben mostrar los puntos geográficos con sus respectivos niveles de radiación y colores de alerta. | EPIC03 |
| US46 | Desarrollo de Alarms | Como developer de TukunTech,<br>Quiero implementar la sección de alarmas,<br>Para visualizar y gestionar las alertas generadas por la plataforma. | Escenario 1:<br>Dado que el developer de TukunTech está desarrollando la sección de alarmas,<br><br>Cuando se active una alerta por algún evento anómalo,<br><br>Entonces debe visualizarse en la lista de alarmas junto con su nivel de gravedad y hora de generación. | EPIC03 |
| US47 | Desarrollo de Profile | Como developer de TukunTech,<br>Quiero implementar la sección de perfil,<br>Para que los usuarios puedan ver y editar su información personal. | Escenario 1:<br>Dado que el developer de TukunTech está trabajando en la sección de perfil,<br><br>Cuando el usuario acceda a su perfil,<br><br>Entonces debe poder visualizar y editar su información básica sin errores. | EPIC03 |
| US48 | Desarrollo de Dashboard | Como developer de TukunTech,<br>Quiero implementar el dashboard principal,<br>Para mostrar un resumen general de la plataforma y accesos rápidos. | Escenario 1:<br>Dado que el developer de TukunTech está trabajando en el dashboard,<br><br>Cuando se acceda al mismo,<br><br>Entonces se debe mostrar un resumen con métricas clave, accesos directos y alertas relevantes de forma clara. | EPIC03 |
| US49 | Gestión de Devices | Como developer de TukunTech,<br>Quiero implementar y consumir los endpoints del módulo de dispositivos,<br>Para mantener actualizada y gestionable la información desde la aplicación. | Escenario 1:<br>Dado que el endpoint "/api/v1/devices" está disponible,<br><br>Cuando se realice una solicitud GET,<br><br>Entonces se debe retornar una lista de dispositivos con estado 200.<br><br>Escenario 2:<br>Dado que el endpoint "/api/v1/devices" está disponible,<br><br>Cuando se envíe una solicitud POST con datos válidos,<br><br>Entonces se debe crear un nuevo dispositivo con estado 201.<br><br>Escenario 3:<br>Dado que el endpoint "/api/v1/devices/{id}" está disponible,<br><br>Cuando se envíe una solicitud PUT con datos actualizados,<br><br>Entonces el dispositivo debe ser actualizado con estado 200.<br><br>Escenario 4:<br>Dado que el endpoint "/api/v1/devices/{id}" está disponible,<br><br>Cuando se envíe una solicitud DELETE,<br><br>Entonces el dispositivo debe eliminarse con estado 204.<br><br>Escenario 5:<br>Dado que se usa un ID inexistente en cualquier operación,<br><br>Entonces debe retornarse un error 404 con un mensaje descriptivo. | EPIC04 |
| US50 | Gestión de Map Radiation | Como developer de TukunTech,<br>Quiero consumir los endpoints relacionados con puntos de radiación,<br>Para visualizarlos y gestionarlos en el mapa de la aplicación. | Escenario 1:<br>Dado que el endpoint "/api/v1/map" está disponible,<br><br>Cuando se envíe una solicitud GET,<br><br>Entonces se deben retornar los puntos de radiación con estado 200.<br><br>Escenario 2:<br>Dado que el endpoint "/api/v1/map" está disponible,<br><br>Cuando se envíe una solicitud POST con datos geográficos válidos,<br><br>Entonces se debe crear un nuevo punto con estado 201.<br><br>Escenario 3:<br>Dado que el endpoint "/api/v1/map/{id}" está disponible,<br><br>Cuando se envíe una solicitud PUT,<br><br>Entonces el punto debe actualizarse correctamente con estado 200.<br><br>Escenario 4:<br>Dado que el endpoint "/api/v1/map/{id}" está disponible,<br><br>Cuando se envíe una solicitud DELETE,<br><br>Entonces el punto debe eliminarse con estado 204.<br><br>Escenario 5:<br>Dado un ID inexistente,<br><br>Entonces cualquier operación debe retornar un estado 404. | EPIC04 |
| US51 | Gestión de Alarms | Como developer de TukunTech,<br>Quiero consumir los endpoints de alarmas,<br>Para mostrar, crear, actualizar y eliminar alertas del sistema. | Escenario 1:<br>Dado que el endpoint "/api/v1/alarms" está disponible,<br><br>Cuando se realice una solicitud GET,<br><br>Entonces se debe retornar la lista de alarmas activas con estado 200.<br><br>Escenario 2:<br>Dado que el endpoint "/api/v1/alarms" está disponible,<br><br>Cuando se envíe una solicitud POST con datos válidos,<br><br>Entonces se debe registrar una nueva alarma con estado 201.<br><br>Escenario 3:<br>Dado que el endpoint "/api/v1/alarms/{id}" está disponible,<br><br>Cuando se envíe una solicitud PUT,<br><br>Entonces la alarma debe actualizarse con estado 200.<br><br>Escenario 4:<br>Dado que el endpoint "/api/v1/alarms/{id}" está disponible,<br><br>Cuando se envíe una solicitud DELETE,<br><br>Entonces la alarma debe eliminarse con estado 204.<br><br>Escenario 5:<br>Dado un ID inexistente,<br><br>Entonces debe retornarse un error 404 con mensaje de alarma no encontrada. | EPIC04 |
| US52 | Gestión de Profile | Como developer de TukunTech,<br>Quiero consumir los endpoints del perfil del usuario,<br>Para visualizar, editar y eliminar los datos personales del usuario. | Escenario 1:<br>Dado que el endpoint "/api/v1/users/{id}/profile" está disponible,<br><br>Cuando se envíe una solicitud GET,<br><br>Entonces se deben retornar los datos del perfil con estado 200.<br><br>Escenario 2:<br>Dado que el endpoint está disponible,<br><br>Cuando se envíe una solicitud PUT con nuevos datos,<br><br>Entonces el perfil debe actualizarse con estado 200.<br><br>Escenario 3:<br>Dado que el endpoint está disponible,<br><br>Cuando se envíe una solicitud DELETE,<br><br>Entonces el perfil debe eliminarse con estado 204.<br><br>Escenario 4:<br>Dado que se utiliza un ID inexistente en cualquier operación,<br><br>Entonces se debe recibir una respuesta 404 con mensaje de error. | EPIC04 |
| US53 | Consulta de Dashboard | Como developer de TukunTech,<br>Quiero obtener los datos generales de la plataforma desde el dashboard,<br>Para visualizar métricas clave y accesos rápidos. | Escenario 1:<br>Dado que el endpoint "/api/v1/dashboard" está disponible,<br><br>Cuando se realice una solicitud GET,<br><br>Entonces deben mostrarse métricas como pacientes, alarmas y dispositivos con estado 200.<br><br>Escenario 2:<br>Dado un error del servidor o falta de datos,<br><br>Cuando se realice la solicitud GET,<br><br>Entonces se debe recibir un estado 500 o un mensaje que indique la falla. | EPIC04 |
| US54 | Actualización de Perfil | Como usuario,<br>Quiero modificar mis datos personales,<br>Para mantener mi perfil actualizado. | Escenario 1:<br>Dado que el endpoint "/api/v1/users/{id}/profile" está disponible,<br><br>Cuando el usuario envíe una solicitud PUT con datos válidos,<br><br>Entonces se debe retornar estado 200 y reflejar los cambios en el perfil.<br><br>Escenario 2:<br>Dado que se envían datos inválidos o incompletos,<br><br>Cuando se realice la solicitud PUT,<br><br>Entonces se debe retornar estado 400 con un mensaje de validación.<br><br>Escenario 3:<br>Dado que se utiliza un ID inexistente,<br><br>Cuando se realice la solicitud PUT,<br><br>Entonces se debe retornar estado 404 con un mensaje como: "El perfil solicitado no existe." | EPIC03 |
| US55 | Visualización de Dashboard | Como usuario,<br>Quiero visualizar un panel con el estado general de todos los dispositivos y alertas,<br>Para tener una visión completa del sistema. | Escenario 1:<br>Dado que el usuario accede a la sección de dashboard desde la interfaz,<br><br>Cuando se cargue la pantalla,<br><br>Entonces se deben mostrar métricas generales como cantidad de dispositivos activos, alertas recientes y estado del sistema.<br><br>Escenario 2:<br>Dado que ocurre un fallo en la carga de datos,<br><br>Cuando se accede al dashboard,<br><br>Entonces se debe mostrar un mensaje de error o estado vacío que indique que no fue posible cargar la información. | EPIC03 |
...
| 35 | US55|Visualización de Dashboard | Como usuario,<br>Quiero visualizar un panel con el estado general de todos los dispositivos y alertas,<br>Para tener una visión completa del sistema. | 5 |
| 36 | US35|Historial de Dispositivos | Como usuario,<br>Quiero revisar el historial de lecturas de cada dispositivo,<br>Para analizar su comportamiento a lo largo del tiempo. | 5 |
| 37 | US36|Exportación de Historial | Como usuario,<br>Quiero exportar el historial de lecturas de dispositivos,<br>Para analizarlos externamente o compartirlos. | 5 |
| 38 | US37|Gestión de Dispositivos | Como administrador,<br>Quiero agregar, editar o eliminar dispositivos de monitoreo,<br>Para mantener actualizado el sistema. | 5|
| 39 | US38|Configuración de Dispositivos | Como administrador,<br>Quiero configurar los parámetros y ubicación de cada dispositivo,<br>Para asegurar un monitoreo correcto según el entorno. | 5 |
| 40 | US39|Visualización de Historial de Alarmas | Como usuario,<br>Quiero consultar el historial de alarmas del sistema,<br>Para identificar eventos de riesgo anteriores. | 5 |
| 41 | US40|Gestión de Alarmas | Como usuario,<br>Quiero marcar alarmas como resueltas o en revisión,<br>Para mantener el sistema actualizado y organizado. | 5 |
| 42 | US41|Mapa de Radiación | Como usuario,<br>Quiero visualizar un mapa con los niveles de radiación en tiempo real,<br>Para conocer las zonas con mayor exposición. | 5 |
| 43 | US42|Filtrado del Mapa | Como usuario,<br>Quiero aplicar filtros al mapa de radiación,<br>Para identificar patrones según fecha, zona o nivel. | 5 |
| 44 | US43|Compartir el Mapa | Como usuario,<br>Quiero compartir el mapa de radiación con otros,<br>Para informarles sobre los niveles actuales de exposición. | 5 |
| 45 | US54|Actualización de Perfil | Como usuario,<br>Quiero modificar mis datos personales,<br>Para mantener mi perfil actualizado. | 5|
| 46      | US49           | Gestión de Devices         | Como developer de TukunTech, Quiero implementar y consumir los endpoints del módulo de dispositivos, Para mantener actualizada y gestionable la información desde la aplicación.                                           | 8             |
| 47      | US50           | Gestión de Map Radiation   | Como developer de TukunTech, Quiero consumir los endpoints relacionados con puntos de radiación, Para visualizarlos y gestionarlos en el mapa de la aplicación.                                                             | 8             |
| 48      | US51           | Gestión de Alarms          | Como developer de TukunTech, Quiero consumir los endpoints de alarmas, Para mostrar, crear, actualizar y eliminar alertas del sistema.                                                                                      | 8             |
| 49      | US52           | Gestión de Profile         | Como developer de TukunTech, Quiero consumir los endpoints del perfil del usuario, Para visualizar, editar y eliminar los datos personales del usuario.                                                                     | 8             |
| 50      | US53           | Consulta de Dashboard      | Como developer de TukunTech, Quiero obtener los datos generales de la plataforma desde el dashboard, Para visualizar métricas clave y accesos rápidos.                                                                      | 8             |
| 51      | US44           | Desarrollo de Devices     | Como developer de TukunTech, Quiero implementar la sección de dispositivos, Para visualizar todos los dispositivos registrados en la plataforma.                                                                            | 8             |
| 52      | US45           | Desarrollo de Map Radiation | Como developer de TukunTech, Quiero implementar la sección del mapa de radiación, Para visualizar los niveles de radiación registrados por zona geográfica.                                                                | 8             |
| 53      | US46           | Desarrollo de Alarms      | Como developer de TukunTech, Quiero implementar la sección de alarmas, Para visualizar y gestionar las alertas generadas por la plataforma.                                                                                | 8             |
| 54      | US47           | Desarrollo de Profile     | Como developer de TukunTech, Quiero implementar la sección de perfil, Para que los usuarios puedan ver y editar su información personal.                                                                                   | 8             |
| 55      | US48           | Desarrollo de Dashboard   | Como developer de TukunTech, Quiero implementar el dashboard principal, Para mostrar un resumen general de la plataforma y accesos rápidos.                                                                                | 8             |
...
![Image](https://github.com/user-attachments/assets/66441613-8f47-48d5-942b-704a30ee0ddb)
...
![Leadership and Collaboration Matrix](https://github.com/user-attachments/assets/fee83b09-e5c9-4a4f-905d-16f8116e9c51)
...
| Attendees (to planning meeting) | Esteban Daniel Espinoza Ayquipa, Mel Andree, Orellana Rodriguez, Fabricio Lopes de La Cruz, Fabio Maurizio Nicolich Alvis |
...
| US52       | 9  | Gestión de Profile            | Como developer de TukunTech, Quiero consumir los endpoints del perfil del usuario, Para visualizar, editar y eliminar los datos personales del usuario.                                                                    | 5h                 | Esteban      | Done   |
| US53       | 10 | Consulta de Dashboard         | Como developer de TukunTech, Quiero obtener los datos generales de la plataforma desde el dashboard, Para visualizar métricas clave y accesos rápidos.                                                                     | 5h                 | Andree       | Done   |
